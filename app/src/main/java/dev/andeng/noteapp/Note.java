...
public class Note {
    ...
    private boolean isPinned; // Property to track if the note is pinned
    ...
    // Getters and setters for title and content remain unchanged
     ...
     */
    // Equals and hashCode methods remain unchanged
    @Override
